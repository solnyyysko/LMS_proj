...
#     html = f"<h1>Страница приложения tasks</h1><a href='{project_list_url}'>Список проектов</a><br><a href='{quality_control_url}'>Приложение quality_control</a>"
...
# def task_detail(response, project_id, task_id):
#     project = get_object_or_404(Project, id=project_id)
...
class IndexView(View):
    def get(self, request, *args, **kwargs):
        ...
        quality_control_url = reverse('quality_control:index')
        html = f"<h1>Страница приложения tasks</h1><a href='{projects_list_url}'>Список проектов</a><br><a href='{quality_control_url}'>Приложение quality_control</a>"
        return HttpResponse(html)
